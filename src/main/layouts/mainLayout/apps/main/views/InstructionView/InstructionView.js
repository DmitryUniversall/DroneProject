...
class InstructionView extends BaseView {
    ...
    renderView() {
        return (
            <div id="InstructionView" className="w-100">
                        ...
                        <Row>
                            <Col lg={9}>
                                {
                                    Object.entries(instruction).map(([group, blocks]) =>
                                        <div id={group} className="group" key={group}>
                                            ...
                                            {
                                                blocks.map((block) =>
                                                    <section className="block pt-3 pb-3 mb-sm-3 mb-lg-0"
                                                             id={block.blockName} key={Math.random()}>
                                                        <Row>
                                                            <Col lg={6}>
                                                                <Row>
                                                            ...
                                                            <Col lg={6}>
                                                                <div
                                                                    className="h-100 w-100 d-flex flex-column justify-content-center pt-3 pt-lg-0">
                                                                    <InstructionImage image={block.image}/>
                                                                </div>
                                                            </Col>
                                                        </Row>
                                                    </section>
                            ...
                            <Col lg={3}>
                                <div className="content_nav no-select">
                                    ...
                                    <div className="d-none d-md-flex flex-column justify-content-start">
                                        {
                                            Object.entries(instruction).map(([group, blocks]) =>
                                                <div key={Math.random()}>
                                                    <div
