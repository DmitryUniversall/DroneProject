const info = [
    {
        ...
        themes: [
            ...
            {
                title: "Разработка web-сайта V1.1: Что нового",
                texts: [
                    {
                        author: "Мурашов Дмитрий",
                        author_role: "Программист",
                        text: "На сайт была добавлена полноценная страница с инструкцией, а так же поддержка смены светлой и тёмной цветовых тем (сделать это можно с помощью кнопки в правом верхнем углу)"
                    }
                ]
            }
        ]
